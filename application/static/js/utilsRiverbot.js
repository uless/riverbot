$(document).ready(function () {
    ...
    function displayLoadingAnimation() {
        ...
        botMessage.innerHTML = `
           <div class="card-body welcome-message pb-0" >
      <div class="row justify-content-start">
        <div class="col-auto d-flex flex-wrap align-items-center justify-content-center">
          <img class="waterdrop1" />
        </div>
        <div class="align-items-center col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9 col-9 bot-message-body">
